...
{
    // ==========================================
    // MODEL TƯƠNG ỨNG VỚI BẢNG 'users' TRÊN SUPABASE
    // ==========================================
    [Table("users")]
    ...
    public partial class LoginForm : Form
    {
        ...
        // ==========================================
        // XỬ LÝ ĐĂNG NHẬP VỚI SUPABASE (ASYNC)
        // ==========================================
        private async void btnLogin_Click(object sender, EventArgs e)
        {
            ...
            // Vô hiệu hóa nút bấm tạm thời để tránh bấm nhiều lần
            btnLogin.Enabled = false;
            btnLogin.Text = "ĐANG XỬ LÝ...";

            try
            {
                // Băm mật khẩu ra SHA256 (Khuyên dùng để bảo mật)
        ...
        // Hàm băm mật khẩu SHA256 đơn giản
